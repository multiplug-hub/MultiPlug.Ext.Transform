...
(function ($) {
    ...
    Dirty.prototype = {
        ...
        setDirtyPermanent: function () {
            this.isDirtyPermanent = true;
            this.setAsDirty();
        },

        setClean: function () {
            if (this.isDirtyPermanent) {
                return;
            }
    ...
    $.fn.dirty = function (options) {
        ...
        if (typeof options === "string" && /^(isDirty|isClean|refreshEvents|resetForm|setAsClean|setAsDirty|setAsDirty|setAsDirtyPermanent|showDirtyFields)$/i.test(options)) {
            ...
            switch (optionsLowerCase) {
                ...
                case "setasdirtypermanent":
                    return d.setDirtyPermanent();
            }
...
$(".mp-event-picker").on("click", function () {
    $("form").dirty("setAsDirtyPermanent");
});